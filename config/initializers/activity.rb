...
module ACTIVITY_TYPE
  NAME = {
      ...
      goal_fail_no_account:              { message: '目標貯金「%s」への貯金ができませんでした。目標貯金に口座が設定されていません。', url: 'osidori://goals/%d'},
      goal_fail_short_of_money:          { message: '目標貯金「%s」への貯金ができませんでした。設定された口座が残高不足です。', url: 'osidori://goals/%d'},
