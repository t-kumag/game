...
module ACTIVITY_TYPE
  NAME = {
      ...
      'goal_created_partner'          => { message: 'パートナーが目標貯金「%s」を作成しました', url: 'osidori://financial-accounts'},
      ...
      'person_expend_rev'             => { message: '個人の取引が%d件ありました', url: 'osidori://financial-accounts'},
      'person_expend_to_fam'          => { message: 'あなたが取引を家族ホームに振り分けました', url: 'osidori://financial-accounts'},
      'person_expend_to_fam_partner'  => { message: 'パートナーが取引を家族ホームに振り分けました', url: 'osidori://transactions'},
      'person_account_to_fam'         => { message: 'あなたの口座を家族ホームに移行しました', url: 'osidori://transactions/%d'},
      'person_account_to_fam_partner' => { message: 'パートナーの口座が家族ホームに移行しました。', url: 'osidori://financial-accounts'},
      'individual_manual_outcome'     => { message: '手動で明細が作成されました。', url: 'osidori://transactions/%d'},
