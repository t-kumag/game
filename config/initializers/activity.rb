...
module ACTIVITY_TYPE
  NAME = {
      ...
      person_tran_to_familly:            { message: 'あなたが取引明細を家族画面に振り分けました', url: 'osidori://transactions/%d?type=%s&account_id=%d&account=%s'},
      person_tran_to_familly_partner:    { message: 'パートナーが取引明細を家族画面に振り分けました', url: 'osidori://transactions/%d?type=%s&account_id=%d&account=%s'},
