...
module ACTIVITY_TYPE
  NAME = {
      ...
      person_tran_to_familly:            { message: 'あなたが取引を家族ホームに振り分けました', url: 'osidori://transactions/%d'},
      person_tran_to_familly_partner:    { message: 'パートナーが取引を家族ホームに振り分けました', url: 'osidori://transactions/%d'},
      person_account_to_familly:         { message: 'あなたの口座を家族ホームに移行しました', url: 'osidori://financial-accounts'},
      person_account_to_familly_partner: { message: 'パートナーの口座が家族ホームに移行しました。', url: 'osidori://financial-accounts'},
