...
module ACTIVITY_TYPE
  NAME = {
      ...
      person_wallet_to_family:           { message: 'あなたがお財布を家族画面に登録しました', url: 'osidori://wallet-account?wallet_id=%d&account=%s'},
      person_wallet_to_family_partner:   { message: 'パートナーがお財布を家族画面に登録しました', url: 'osidori://wallet-account?wallet_id=%d&account=%s'},
