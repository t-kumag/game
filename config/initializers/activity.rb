...
module ACTIVITY_TYPE
  NAME = {
      ...
      person_account_to_familly:         { message: 'あなたが登録金融機関を家族画面に登録しました', url: 'osidori://financial-accounts'},
      person_account_to_familly_partner: { message: 'パートナーが登録金融機関を家族画面に登録しました', url: 'osidori://financial-accounts'},
