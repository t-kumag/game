...
RSpec.describe Api::V2::User::CardTransactionsController do
  ...
  describe '#index' do
    context 'success' do
      it 'response 200' do
        get "/api/v2/user/card-accounts/#{at_user_card_account.id}/transactions/", params: params, headers: headers
