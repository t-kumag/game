...
RSpec.describe 'pl_controller' do
  ...
  describe '#summary' do
    context 'success' do
      it 'response 200' do
        get "/api/v1/user/pl-summary", params: params, headers: headers
  ...
  describe '#categories' do
    context 'success' do
      it 'response 200' do
        get "/api/v1/user/pl-categories", params: params, headers: headers
        expect(response.status).to eq 200
      end
  ...
  describe '#grouped_categories' do
    context 'success' do
      it 'response 200' do
        get "/api/v1/user/pl-grouped-categories", params: params, headers: headers
        expect(response.status).to eq 200
      end
