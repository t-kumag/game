...
class Services::UserDistributedTransactionService
  ...
  def sync_at_user_bank_transactions
    ...
    accounts.each do |account|
      ...
      Entities::UserDistributedTransaction.import save_list,
                                                  :on_duplicate_key_update => [:user_id, :share, :used_date, :at_user_bank_transaction_id, :used_location, :amount, :at_transaction_category_id],
                                                  :validate => false
    end
  end
  ...
  def sync_at_user_card_transactions
    ...
    accounts.each do |account|
      ...
      Entities::UserDistributedTransaction.import save_list,
                                                  :on_duplicate_key_update => [:user_id, :share, :used_date, :at_user_card_transaction_id, :used_location, :amount, :at_transaction_category_id],
                                                  :validate => false
    end
  end
  ...
  def sync_at_user_emoney_transactions
    ...
    accounts.each do |account|
      ...
      Entities::UserDistributedTransaction.import save_list,
                                                  :on_duplicate_key_update => [:user_id, :share, :used_date, :at_user_emoney_transaction_id, :used_location, :amount, :at_transaction_category_id],
                                                  :validate => false
    end
  end
